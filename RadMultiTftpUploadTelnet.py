#python script version 0.3 January 2021 to access via telnet
#and export via tftp the startup-config from a list of Rad
...
print ("########################################################")
print ("Python script to export startup-config via TFTP from Rad")
print ("##########FaAndàIMan####################################")
...
for line in iplist:
 ...
 try:
  ...
  config_file = "file copy startup-config tftp://" + tftp_server + "/startup-config_" + Host + "_" + timestr
